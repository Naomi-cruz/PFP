 ...
 * @author ERIKA GARCIA
 */
public class Grupos_Alumno extends javax.swing.JFrame {

    /**
     * Creates new form Inicio_Alumno
     */
    public Grupos_Alumno() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Grupos_Alumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Grupos_Alumno().setVisible(true);
            }
        });
    }
