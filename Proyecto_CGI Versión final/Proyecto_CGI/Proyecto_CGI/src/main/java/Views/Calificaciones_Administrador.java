...
public class Calificaciones_Administrador extends javax.swing.JFrame {

    public Calificaciones_Administrador() {
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre del alumno", "No. De control", "Calificación", "Tipo de evaluación"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calificaciones_Administrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calificaciones_Administrador().setVisible(true);
            }
        });
    }
