 ...
 * @author ERIKA GARCIA
 */
public class DetallesActividad_Administrador extends javax.swing.JFrame {

    /**
     * Creates new form Inicio_Alumno
     */
    public DetallesActividad_Administrador() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetallesActividad_Administrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetallesActividad_Administrador().setVisible(true);
            }
        });
    }
