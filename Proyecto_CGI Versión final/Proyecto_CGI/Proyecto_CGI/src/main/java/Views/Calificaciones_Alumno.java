 ...
 * @author ERIKA GARCIA
 */
public class Calificaciones_Alumno extends javax.swing.JFrame {

    /**
     * Creates new form Inicio_Alumno
     */
    public Calificaciones_Alumno() {
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre de la materia", "Grupo", "Calificación", "Tipo de evaluación"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calificaciones_Alumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calificaciones_Alumno().setVisible(true);
            }
        });
    }
