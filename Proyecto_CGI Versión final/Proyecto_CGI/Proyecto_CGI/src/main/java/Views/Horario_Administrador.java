...
public class Horario_Administrador extends javax.swing.JFrame {

    public Horario_Administrador() {
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre de la materia", "Grupo", "Aula", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Horario_Administrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Horario_Administrador().setVisible(true);
            }
        });
    }
